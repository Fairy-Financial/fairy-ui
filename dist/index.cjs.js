...
var DefaultSeparator = React__default['default'].createElement(Icon$Q, { color: "currentColor", width: "24px" });
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArrays(Array(count)).map(function (_, index) { return (React__default['default'].createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React__default['default'].createElement(Icon$I, { width: size, height: size }))); });
...
var RotatingPancakeIcon = styled__default['default'](Icon$r)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
    ...
    return (React__default['default'].createElement(StyledModal, null,
        React__default['default'].createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default['default'].createElement(Icon$O, { color: "primary" })))),
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Blizzard home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Blizzard home page" }, innerLogo))));
};
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React__default['default'].createElement(Icon$_, null) : React__default['default'].createElement(Icon$$, null)),
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://pancakeswap.info/token/0xcB31558b2CF2A20465C37899f3cB635dd30e0e31", target: "_blank" },
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$L, { width: "20px", color: "primary", ml: "4px" }),
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement(Icon$F, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, 
...
exports.AddIcon = Icon$12;
exports.Alert = Alert;
exports.ArrowBackIcon = Icon$11;
exports.ArrowDownIcon = Icon$10;
exports.ArrowDropDownIcon = Icon$$;
exports.ArrowDropUpIcon = Icon$_;
exports.ArrowForwardIcon = Icon$Z;
exports.AutoRenewIcon = Icon$Y;
exports.BackgroundImage = BackgroundImage;
exports.BaseLayout = GridLayout$1;
exports.BinanceIcon = Icon$X;
exports.BlockIcon = Icon$14;
exports.Box = Box;
exports.Breadcrumbs = Breadcrumbs;
exports.BunnyPlaceholderIcon = Icon$W;
exports.Button = Button;
exports.ButtonMenu = ButtonMenu;
exports.ButtonMenuItem = ButtonMenuItem;
exports.CalculateIcon = Icon$U;
exports.Card = Card;
exports.CardBody = CardBody;
exports.CardFooter = CardFooter;
exports.CardHeader = CardHeader;
exports.CardRibbon = CardRibbon;
exports.CardViewIcon = Icon$V;
exports.CardsLayout = GridLayout;
exports.Checkbox = Checkbox;
exports.CheckmarkCircleIcon = Icon$16;
exports.CheckmarkIcon = Icon$T;
exports.ChevronDownIcon = Icon$S;
exports.ChevronLeftIcon = Icon$R;
exports.ChevronRightIcon = Icon$Q;
exports.ChevronUpIcon = Icon$P;
exports.CloseIcon = Icon$O;
exports.CogIcon = Icon$N;
exports.CommunityIcon = Icon$M;
exports.CopyIcon = Icon$L;
exports.Dropdown = Dropdown;
exports.ErrorIcon = Icon$15;
...
exports.Image = Image;
exports.InfoIcon = Icon$13;
exports.Input = Input$1;
exports.Link = Link;
exports.LinkExternal = LinkExternal;
exports.ListViewIcon = Icon$J;
exports.LogoIcon = Icon$I;
exports.LogoRoundIcon = Icon$H;
exports.Menu = Menu;
exports.MinusIcon = Icon$G;
exports.Modal = Modal;
exports.ModalProvider = ModalProvider;
exports.NoProfileAvatarIcon = Icon$F;
