    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$O, { width: "24px", color: "currentColor" }))))));
};
...
var DefaultSeparator = React.createElement(Icon$Q, { color: "currentColor", width: "24px" });
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArrays(Array(count)).map(function (_, index) { return (React.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React.createElement(Icon$I, { width: size, height: size }))); });
...
var RotatingPancakeIcon = styled(Icon$r)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$O, { color: "primary" })))),
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { height: "26", href: '/images/blzd/logoWithText.png' })));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$I, { className: "mobile-icon" }),
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Blizzard home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Blizzard home page" }, innerLogo))));
};
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React.createElement(Icon$_, null) : React.createElement(Icon$$, null)),
        ...
        if (entry.items) {
            ...
            return (React.createElement(Accordion$1, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React.createElement(MenuLink, { href: item.href, target: item.external ? "_blank" : "_self" }, item.label))); })));
        }
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, { href: entry.href, target: entry.external ? "_blank" : "_self", onClick: handleClick },
                iconElement,
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$L, { width: "20px", color: "primary", ml: "4px" }),
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React.createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React.createElement(Icon$F, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang; _a.cakePriceUsd; var links = _a.links, profile = _a.profile, children = _a.children;
    ...
    return (React.createElement(Wrapper, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, 
                // cakePriceUsd={cakePriceUsd}
                pushNav: setIsPushed, links: links }),
...
export { Icon$12 as AddIcon, Alert, Icon$11 as ArrowBackIcon, Icon$10 as ArrowDownIcon, Icon$$ as ArrowDropDownIcon, Icon$_ as ArrowDropUpIcon, Icon$Z as ArrowForwardIcon, Icon$Y as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$X as BinanceIcon, Icon$14 as BlockIcon, Box, Breadcrumbs, Icon$W as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$U as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$V as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$16 as CheckmarkCircleIcon, Icon$T as CheckmarkIcon, Icon$S as ChevronDownIcon, Icon$R as ChevronLeftIcon, Icon$Q as ChevronRightIcon, Icon$P as ChevronUpIcon, Icon$O as CloseIcon, Icon$N as CogIcon, Icon$M as CommunityIcon, ConnectorNames, Icon$L as CopyIcon, Dropdown, Icon$15 as ErrorIcon, FallingBunnies, Flex, Heading, Icon$K as HelpIcon, IconButton, Image, Icon$13 as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$J as ListViewIcon, Icon$I as LogoIcon, Icon$H as LogoRoundIcon, Menu, Icon$G as MinusIcon, Modal, ModalProvider, Icon$F as NoProfileAvatarIcon, Icon$E as OpenNewIcon, Icon$D as PrizeIcon, Progress, Icon$A as ProgressBunny, Radio, Icon$C as RemoveIcon, ResetCSS, Icon$w as SearchIcon, Skeleton, Spinner, Svg, Icon$v as SwapVertIcon, Icon$u as SyncAltIcon, Tag, Text, Icon$y as Ticket, Icon$x as TicketRound, ToastContainer, Toggle, Icon$B as VerifiedIcon, Icon$t as WarningIcon, Icon$z as Won, variants as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
